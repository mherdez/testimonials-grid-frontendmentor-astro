...
export const users: UserInterface[] = [
  {
    ...
    title:
      `I received a job offer mid-course, and the subjects I learned were current, if npmore so, in the company I joined. I honestly feel I got every penny’s worth.`,
    review:
  ...
  },
  {
    ...
    photo: {
      file: 'image-kira.jpg',
      alt: 'Kira',
      color: 'testimonials-Very-dark-blackish-blue',
    },
    title:
  ...
  },
  {
    ...
    title:
      `Apome teaching support from TAs who did the bootcamp themselves. Getting guidance from them and learning from their experiences was easy.`,
    review:
